 ...
 */
$config['reg_question_active'] = false; //включен ли вопрос при регистрации
 ...
 * Интеграции
 */
$config['excity_use'] = false; //показывать ли выбор города с выпадающим списком при регистрации (необходим активный плагин extcity)
...
$config['timestamp_protect'] = 3;

$config['watermark_logo'] = true;
